...
class Eigengewicht extends StatefulWidget {
  final List muscleList;
  final String workoutTypeId;

  const Eigengewicht({Key key, this.muscleList, this.workoutTypeId})
      : super(key: key);

  @override
  _EigengewichtState createState() => _EigengewichtState();
}

class _EigengewichtState extends State<Eigengewicht> {
